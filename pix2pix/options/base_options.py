...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # model parameters
        parser.add_argument('--model', type=str, default='pix2pix',  # cycle_gan
                            help='chooses which model to use. [pix2pixunpair | cycle_gan | pix2pix | test | colorization]')
        ...
        parser.add_argument('--netG', type=str, default='resnet_3blocks',
